...
function PageContent({ page, hotel, currentDate, setAddBooking, setOpenRoom }) {
  ...
  return (
    <>
      {page === 'dashboard' && (
        <Dashboard currentDate={currentDate} onAddBooking={(room) => setAddBooking(room || true)} />
      )}
            ...
            <div className="flex items-center gap-3">
              {page === 'dashboard' && (
                <div className="flex items-center gap-1">
                  ...
                  <button
                    onClick={goToday}
                    className="text-xs border border-gray-200 px-2.5 py-1 rounded-lg text-gray-600 hover:border-brand/40 ml-1"
                  >
                    Today
                  </button>
                </div>
